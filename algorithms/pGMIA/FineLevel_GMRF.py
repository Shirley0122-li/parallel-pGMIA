...
def FineLevel_GMRF(this_reg, n_rep, n_init_sol, theta_sol, grid_dim_reg, grid_dim_sol, shift_vector, obj_func, sol_rep, sol_output, sol_var):
...
# FineLevel_GMRF(this_reg, n_rep, n_init_sol, theta_sol, grid_dim_reg, grid_dim_sol, shift_vector, obj_func, sol_rep, sol_output, sol_var)
    ...
    if n2 < n_init_sol:
        ...
        sol_limits = [[0, grid_dim_sol[i]] for i in range(dim_sol)]    # bounds for sampling
    ...
    return [sol_rep, sol_output, sol_var]
